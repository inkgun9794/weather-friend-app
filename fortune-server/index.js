...
const MAX_RETRIES = 3;
const PROMPT_VERSION = 'concise-weather-v11';
...
4. 점수가 높은 날은 도움 요인을 중심으로, 낮은 날은 주의 요인을 중심으로 오늘의 흐름과 실천 행동을 도출한다.
5. 근거 없는 일반론을 만들지 말고, 제공된 명리 분석값과 현재 운의 흐름에 근거한다.
6. 오늘의 점수(${score}점, 20~100·50이 평이)가 본문 전체의 기준 톤이다. 일운에 합·충·형·해·파
   같은 주의 요인이 있어도, 점수 구간보다 더 부정적인 톤으로 본문을 끌어내리지 않는다.
   - 70점 이상: 분명히 긍정적이고 활기 있는 톤. 주의 요인은 본문 흐름의 중심에 두지 말고,
     '챙길 점'에서 좋은 흐름을 더 살리는 가벼운 한 가지로만 다룬다.
   - 40~69점: 담담하고 무난한 톤.
...
## 챙길 점
70점 이상이면 오늘의 좋은 흐름을 더 살리는 행동 한 가지를, 그 아래면 오늘 살펴볼 점에서 도출한 행동 한 가지를 1~2문장, 60자 이내로 작성한다. 경고하거나 불안하게 만드는 표현은 쓰지 않는다.
