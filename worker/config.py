...
# 6시 = audio + push / 21시 = audio in-app message (no push)
MORNING_HOUR = 6
EVENING_HOUR = 21
...
# 6시 (morning) gets TTS audio + push. 21시 (evening) gets TTS audio only.
...
# - evening  (21시): compare today actual + tomorrow forecast  (+ TTS audio, no push)
