...
|---|---|---|---|
| `jiyoung` | 지영 | 다정한 날사친 | `tc_66ab0e26ec23f325b7ad51df` (Yeseul) |
| `sohee` | 소희 | 시크한 날사친 | `tc_6568164fe05ddffee8b0e271` (Siyeon) |
| `jihoon` | 지훈 | 듬직한 날사친 | `tc_61f0859907085fc68561c9a1` (Jihoon) |
| `siwon` | 시원 | 상냥한 날사친 | `tc_61f0859907085fc68561c9a1` (Jihoon) |
